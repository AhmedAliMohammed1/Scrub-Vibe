...
- **Last successful task:** Implemented transactional email notifications via Resend with bilingual (EN/AR) templates, staff alerts, auto-fallback for unverified sender domains (e.g., gmail.com), and fixed cart sync RPC swatch column in Supabase
- **Current branch:** `main`
