...
- **Current task:** Catalogue search and richer filtering
- **Last successful task:** Deployed and configured localized Supabase email/password authentication flows
- **Current branch:** `main`
...
- **Exact next action:** implement catalogue search and richer filtering, preserving localized Supabase reads and URL-addressable filter state.
