...
- **Last successful task:** Hardened admin order updates with auto-proof-approval on payment confirmation, friendly bilingual error and success query banners, and non-blocking transactional email triggers on proof approval and order shipment
- **Current branch:** `main`
