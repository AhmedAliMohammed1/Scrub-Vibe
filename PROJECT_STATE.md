...
- **Latest tests:** PASS — 13 files, 109 tests, including email templates (EN/AR), dev-preview fallback, cart/wishlist sync, shipping quotes, Paymob readiness/HMAC, payment-proof signatures, webhook idempotency invariants, COD deposit channels, OTP modes, authentication and catalogue behavior
